...
const App = () => {
  ...
  return (
    <>
      ...
      <Navbar cartCounter={cartCounter} userLoggedin={userLoggedin} setuserLoggedin={setuserLoggedin} />
      <Switch>
        <Route exact path='/'>
          <Index getMenu={getMenu} userLoggedin={userLoggedin} setcartCounter={setcartCounter} menu={menu}  />
        </Route>
       ...
       <Route exact path='/admin'>
        ...
        <Route exact path='/admin/addmenu'>
          <Adminaddmenu setmenu={setmenu} menu={menu} userLoggedin={userLoggedin}/>
        </Route>
